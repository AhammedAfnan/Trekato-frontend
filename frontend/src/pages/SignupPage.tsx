  ...
  return (
    <FormLayout>
        <div className='w-full max-w-md'>
          ...
          <FormInput id='email' label='Email*' placeholder='Enter your email' type='email' />
          ...
          <FormInput id='confirmPassword' label='Confirm Password*' placeholder='Confirm your password' type='password' />
          ...
          <FooterLink question='Already have an account?' linkText='Log in' linkHref='/login' />
        </div>
